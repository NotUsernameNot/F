...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Credits'],
			['UsernameNot',		    'usernamenot',		'Ported the rips',	 'https://usernamenot.itch.io/',	    'A9A9A9'],
			['SiIvaGunner Team',		'siiva',				'The rips art and music',			 'https://www.youtube.com/c/siivagunner',	    'A9A9A9'],
